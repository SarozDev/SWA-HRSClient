...
class HomeBanner extends Component {
  constructor(props) {
    super(props);
    this.state = {
      inputStart: "01/09/2022",
      inputFinish: "02/10/2022",
      checked: true,
      showrooms: false,
      roomCount: 1,
      guestCount: 1,
            ...
            <div className="col-10 " id={styles.wrapper}>
              ...
              <div className="row px-5 py-4 align-items-cene w-100" id={styles.items}>
                ...
                <div id={styles.searchedPlace}>
                  <span>Chicago Central Transport 17 Sep - 20 Sep | 3 Guests</span>
                </div>
                <div id={styles.searchedPlace}>
                  <span>Columbus Central  Transport 17 Sep - 20 Sep | 3 Guests</span>
                </div>
                <div id={styles.searchedPlace}>
                  <span>New York Central  Transport 17 Sep - 20 Sep | 3 Guests</span>
                </div>
              </div>
            </div>
          </div>
