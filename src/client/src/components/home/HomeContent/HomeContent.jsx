    ...
    return (
      <div className="container my-5">
        ...
        <div className="row mt-5">
          {[
            { heading: "OYO 29781 Prabeen Ex", subHeading: "Some quick example text to build o", rating: "4", icon: faStar, review: "134", val: "Very Good", price: "1389", off: "46%" },
            { heading: "OYO 29781 Abe Ex", subHeading: "Some quick example text to build o", rating: "4", icon: faStar, review: "134", val: "Very Good", price: "1389", off: "46%" },
            { heading: "OYO 29781 KSS Ex", subHeading: "Some quick example text to build o", rating: "4", icon: faStar, review: "134", val: "Very Good", price: "1389", off: "46%" },
          ].map((elem) => {
            return (
